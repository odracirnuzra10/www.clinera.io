  ...
  const plans = [
    {
      ...
      features: [
        "~45 agendamientos automáticos por AURA",
        "500 mensajes IA / mes con AURA",
        "Integración a tu software (WhatsApp API + MCP)",
    ...
    },
    {
      ...
      features: [
        "Mensajería WhatsApp ilimitada con tu equipo",
        "~65 agendamientos automáticos por AURA · incluidos",
    ...
    },
    {
      ...
      features: [
        "Mensajería WhatsApp ilimitada con tu equipo",
        "~90 agendamientos automáticos por AURA · incluidos",
