...
const FAQ = [
  ...
  { q: "¿Cuántas atenciones incluye cada plan?", a: "Una atención = una conversación completa de IA con un paciente por WhatsApp. Conect: ~330 atenciones / mes (10.000 créditos IA, modos Eficiente y Agentic). Advanced: ~500 atenciones / mes (15.000 créditos IA) y 5 usuarios. MAX: ~1.000 atenciones / mes (28.000 créditos IA), incluye además modo Agentic Pro y los agentes LIA y CAMILA (voz). Las atenciones son estimadas y varían según el mix de conversaciones de tu clínica. MAX tiene el mejor costo por atención (~$0,28 vs ~$0,36 Advanced y ~$0,39 Conect). Los números son estimados con mix realista (consultas + agendamientos + tool calls) y con un margen conservador para evitar sorpresas. Si necesitas más, sumas el Add-on de créditos IA (US$50 → ~500 atenciones en Eficiente, ~170 en Agentic o ~50 por voz) o subes de plan." },
  ...
  { q: "¿Qué pasa si supero el cupo de mi plan?", a: "Te avisamos al 80% y al 100% del cupo de atenciones. Tu servicio no se interrumpe sin aviso. Si necesitas más, sumas el Add-on de créditos IA (US$50 → ~500 atenciones en Eficiente, ~170 en Agentic o ~50 por voz) o subes de plan." },
...
function Addons() {
  const items = [
    { price: "$50", unit: "única vez", label: "Add-on de créditos IA",  sub: "+5.000 créditos IA: ~500 atenciones en Eficiente · ~170 en Agentic · ~50 por voz. Recarga opcional cuando agotas tus créditos del mes." },
