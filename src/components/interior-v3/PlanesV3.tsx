...
const FAQ = [
  ...
  { q: "¿Cuántos créditos y conversaciones incluye cada plan?", a: "Core: 13.000 créditos IA / mes — equivalen a ~200 conversaciones. Conect: 18.000 créditos — ~280 conversaciones, con modo automático de agendamiento. Advanced: 78.000 créditos — ~1.200 conversaciones (6× la capacidad IA de Core), con modo automático. Advanced tiene el mejor costo por conversación ($0,30 vs $0,64 Conect y $0,65 Core). Si necesitas más, sumas un add-on de créditos o subes de plan." },
