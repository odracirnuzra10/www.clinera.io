...
const FAQ = [
  ...
  { q: "¿Cuántos créditos y atenciones incluye cada plan?", a: "Core: 8.000 créditos IA / mes — equivalen a ~600 atenciones (modo Eficiente). Conect: 12.000 créditos — ~900 atenciones, incluye modo Óptimo (agendamiento automático). Advanced: 32.000 créditos — ~2.400 atenciones (4× la capacidad IA de Core), incluye además modo Agentic Flash. Advanced tiene el mejor costo por atención ($0,15 vs $0,20 Conect y $0,22 Core). Los números son estimados con mix realista (consultas + agendamientos + tool calls) y con un margen conservador para evitar sorpresas. Si necesitas más, sumas un add-on de créditos o subes de plan." },
  { q: "¿Cuál es la diferencia entre los 3 modos de agendamiento?", a: "Eficiente (Gemini 2.5 Flash, no agéntico): AURA conversa por WhatsApp y envía un link a tu calendario propio o al de Clinera para que el paciente confirme. ~3 créditos por atención — el costo IA más bajo. Disponible desde Core. Óptimo (Kimi K2.6, agéntico automático): AURA agenda directamente en tu calendario, sin links ni fricción. ~13 créditos por atención — la mejor relación capacidad/costo. Disponible desde Conect. Agentic Flash (Gemini 3 Flash, agéntico ultra rápido): mismo nivel agéntico que Óptimo con respuesta inmediata (289 tokens/s). ~28 créditos por atención. Solo en Advanced." },
