...
const FAQ = [
  ...
  { q: "¿Cuántas atenciones incluye cada plan?", a: "Una atención = una conversación completa de IA con un paciente por WhatsApp. Conect: ~270 atenciones / mes (8.000 créditos IA, modos Eficiente y Agentic). Advanced: ~390 atenciones / mes (12.000 créditos IA) y 5 usuarios. MAX: ~1.000 atenciones / mes (28.000 créditos IA), incluye además modo Agentic Flash y los agentes LIA y CAMILA (voz). Las atenciones son estimadas y varían según el mix de conversaciones de tu clínica. MAX tiene el mejor costo por atención (~$0,28 vs ~$0,46 Advanced y ~$0,48 Conect). Los números son estimados con mix realista (consultas + agendamientos + tool calls) y con un margen conservador para evitar sorpresas. Si necesitas más, sumas el Add-on de créditos IA (US$100 → ~300 atenciones por texto o ~50 por voz) o subes de plan." },
  { q: "¿Cuál es la diferencia entre los 3 modos de agendamiento?", a: "Eficiente (Gemini 3.0 Flash, no agéntico): AURA conversa por WhatsApp y envía un link a tu calendario propio o al de Clinera para que el paciente confirme. ~3 créditos por atención — el costo IA más bajo. Disponible en todos los planes. Agentic (Kimi K2.6, agéntico automático): AURA agenda directamente en tu calendario, sin links ni fricción. ~13 créditos por atención — la mejor relación capacidad/costo. Disponible desde Conect. Agentic Flash (Gemini 3.5 Flash, agéntico ultra rápido): mismo nivel agéntico que Agentic con respuesta inmediata (289 tokens/s). ~28 créditos por atención. Solo en MAX." },
  ...
  { q: "¿Qué pasa si supero el cupo de mi plan?", a: "Te avisamos al 80% y al 100% del cupo de atenciones. Tu servicio no se interrumpe sin aviso. Si necesitas más, sumas el Add-on de créditos IA (US$100 → ~300 atenciones por texto o ~50 por voz) o subes de plan." },
...
function Addons() {
  const items = [
    { price: "$100", unit: "única vez", label: "Add-on de créditos IA",  sub: "Créditos IA extra: ~300 atenciones por texto con IA o ~50 atenciones por voz. Recarga opcional cuando agotas tus créditos del mes." },
