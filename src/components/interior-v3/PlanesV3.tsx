...
const FAQ = [
  ...
  { q: "¿Cuántos créditos y conversaciones incluye cada plan?", a: "Core: 13.000 créditos IA / mes — equivalen a ~1.000 conversaciones. Conect: 18.000 créditos — ~1.500 conversaciones, con modo automático de agendamiento. Advanced: 54.000 créditos — ~4.500 conversaciones (4× la capacidad IA de Core), con modo automático. Advanced tiene el mejor costo por conversación ($0,08 vs $0,12 Conect y $0,13 Core). Los números son estimados con mix realista (agendamiento + tool calls + info). Si necesitas más, sumas un add-on de créditos o subes de plan." },
  ...
  { q: "¿Qué pasa si supero el cupo de mi plan?", a: "Te avisamos al 80% y al 100% del cupo de créditos. Tu servicio no se interrumpe sin aviso. Si necesitas más, sumas un add-on de +5.000 créditos IA por $20 USD/mes (≈ ~415 conversaciones extra) o subes de plan." },
...
function Addons() {
  const items = [
    { price: "$20", unit: "/mes", label: "+5.000 créditos IA",          sub: "≈ ~415 conversaciones extra" },
