...
const FAQ = [
  ...
  { q: "¿Qué pasa si supero el cupo de mi plan?", a: "Te avisamos al 80% y al 100% del cupo de atenciones. Tu servicio no se interrumpe sin aviso. Si necesitas más, sumas el add-on de +1.000 atenciones por US$150/mes o subes de plan." },
...
function Addons() {
  const items = [
    { price: "$150", unit: "/mes", label: "+1.000 atenciones",          sub: "Cuando superas el cupo de tu plan" },
