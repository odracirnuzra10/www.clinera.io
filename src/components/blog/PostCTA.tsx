...
export default function PostCTA({ relatedComparativa }: Props) {
  ...
  const subhead = compLabel
    ...
    : `AURA atendiendo WhatsApp 24/7 con tu agenda y tu base de datos. Demo grabada de 5 minutos o reunión con ventas. Planes desde USD 279/mes (permanencia mínima de 6 meses). El primer cobro incluye implementación USD 450 más el primer mes del plan. Los precios publicados están en USD y no incluyen IVA.`;
