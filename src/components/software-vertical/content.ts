...
const PRICE_FAQ = `Vortex desde USD ${vortex.monthlyPrice}/mes, Atlas USD ${atlas.monthlyPrice}, Summit USD ${summit.monthlyPrice}. Permanencia mínima 6 meses. El primer cobro es implementación USD ${SETUP_FEE_NUMBER} más el primer mes del plan; después, el plan mes a mes. El catálogo está en USD; en la web puedes ver MXN a un tipo de cambio fijo. Los precios no incluyen IVA.`;
