...
faq:
  ...
  - q: "¿Vale la pena automatizar la confirmación si tengo poco volumen?"
    a: "Sí. El no-show porcentual no depende del volumen — depende de la fricción del proceso. Una clínica de 60 citas/mes con 30% de no-show pierde el equivalente a USD 1.500-2.500/mes en LTV. El plan Vortex cuesta USD 279/mes — el payback es menor a 30 días."
---
...
Las 4 jugadas vienen pre-configuradas en los planes Vortex (USD 279/mes) y Atlas (USD 379/mes). Setup en menos de 1 hora. AURA se conecta a tu WhatsApp Business actual (sin cambiar de número) y empieza a operar esa misma tarde.
