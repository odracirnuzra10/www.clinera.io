---
title: "Los 3 modos de agendamiento con IA en Clinera: Eficiente, Agentic y Agentic Pro"
description: "Eficiente, Agentic y Agentic Pro: qué modelo usa cada modo (Gemini 3.0 Flash, Kimi K2.6 y Gemini 3.5 Flash), cuántos créditos consume, qué hace cada uno y para qué tipo de clínica conviene."
...
faq:
  ...
  - q: "¿En qué planes está disponible cada modo?"
    a: "Eficiente desde Plan Core (USD 89/mes). Agentic desde Plan Conect (USD 179/mes). Agentic Pro solo en Plan Advanced (USD 359/mes). Puedes cambiar de modo en cualquier momento dentro de tu plan si tienes el cupo de créditos para sostenerlo."
---
...
- Plan Advanced. La densidad de créditos del plan Advanced (32.000 créditos al mes) está calibrada justamente para que la economía de Agentic Pro funcione.
...
<div style={{ overflowX: "auto", margin: "20px 0", border: "1px solid #EEECEA", borderRadius: 12 }}>
  <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 15, lineHeight: 1.5 }}>
    ...
    <tbody>
      ...
      <tr>
        <td style={{ padding: "14px 16px", fontWeight: 600, color: "#0A0A0A" }}>Agentic Pro</td>
...
1. **Si la conversión depende de cerrar la cita en el mismo chat**: Agentic o Agentic Pro. El link que abre el paciente en Eficiente tiene una tasa de abandono real entre 8% y 15% según la vertical — eso es ventas perdidas que ya estaban casi cerradas.
2. **Si la conversión depende de la velocidad de respuesta**: Agentic Pro. Sirve cuando compites por leads inmediatos (típicamente Meta Ads en estética) y el primer mensaje rápido se queda con el paciente.
...
Si recién partes, lo más probable es que necesites **Agentic**. Si tu clínica vive de inmediatez y compite por leads en caliente, **Agentic Pro**. Si quieres probar la categoría sin compromiso, **Eficiente** en plan Core es la entrada más barata del mercado.
