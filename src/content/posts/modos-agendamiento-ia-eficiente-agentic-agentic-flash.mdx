...
faq:
  ...
  - q: "¿En qué planes está disponible cada modo?"
    a: "Eficiente y Agentic están disponibles desde el Plan Vortex (USD 279/mes). Agentic Pro desde el Plan Atlas (USD 379/mes). Puedes cambiar de modo en cualquier momento dentro de tu plan si tienes el cupo de créditos para sostenerlo."
---
  ...
  <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 15, lineHeight: 1.5 }}>
    ...
    <tbody>
      <tr style={{ borderBottom: "1px solid #F3F2F0" }}>
        ...
        <td style={{ padding: "14px 16px", color: "#374151" }}>Vortex</td>
      </tr>
      ...
      <tr>
        ...
        <td style={{ padding: "14px 16px", color: "#374151" }}>Atlas</td>
      </tr>
    </tbody>
  </table>
</div>
...
[Ver planes desde USD 279/mes](/planes) · [Hablar con ventas](/hablar-con-ventas) · [Ver el estudio de efectividad](/efectividad)
