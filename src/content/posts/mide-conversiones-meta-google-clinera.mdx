...
n8n Cloud Starter cuesta alrededor de USD 20 al mes y cubre hasta 5.000 ejecuciones mensuales, suficiente para una clínica mediana. Si ya tienes n8n self-hosted o usas Clinera Vortex (que incluye n8n integrado), el costo adicional es cero.

### ¿Funciona con cualquier plan de Clinera?

Este flujo necesita **API y webhooks salientes**, disponibles en el **plan Summit**. Los planes Vortex y Atlas incluyen automatizaciones internas (recordatorios, reagendamientos, mensajería), pero no permiten enviar webhooks a sistemas externos como n8n. Si estás en Vortex o Atlas y necesitas este tracking, contáctanos para subir a Summit.
